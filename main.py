...
def test_nn(nn):
    ...
    with open("log.txt", 'a') as f:
        f.write("Squared Loss on train: {:.3f}\n".format(train_mean_sq_loss))
        f.write("0/1 Loss on train: {:.3f}\n".format(train_err))
    ...
    with open("log.txt", 'a') as f:
        f.write("Squared Loss on test: {:.3f}\n".format(test_mean_sq_loss))
        f.write("0/1 Loss on test: {:.3f}\n".format(test_err))
